...
/**
 * @version		$Id: helper.php 1939 2015-07-04 14:16:48Z gerrit_hoekstra $
 * @package		Joomla
...
class JInstallationHelper
{
	...
	function createAdminUser(& $vars)
	{
		...
		$query = "INSERT INTO #__users VALUES (62, 'Administrator', 'admin', ".$db->Quote($adminEmail).", ".$db->Quote($cryptpass).", 'Super Administrator', 0, 1, 25, '$installdate', '$nullDate', '','admin_language=af-ZA language=af-ZA editor= helpsite= timezone=0')";
		$db->setQuery($query);
		if (!$db->query())
		{
